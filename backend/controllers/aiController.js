...
const generateOutline = async (req, res) => {
  try {
    ...
    Output Format:
    Return ONLY a valid JSON array with on additional text, markdown, or formatting. Each object must have exactly two keys: "title" and "description".
...
const generateChapterContent = async (req, res) => {
  try {
    ...
    5. Make the content engaging valuable to readers
    ${
      chapterDescription
    ...
    - End with a strong conclusion or transition on the next chapter
